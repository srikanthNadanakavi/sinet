...
namespace API.Controllers
{
    ...
    {
        private readonly StoreContext _storConext;
        public ProductsController(StoreContext storConext)
        {
            _storConext = storConext;
        }

        [HttpGet]
        public async Task<ActionResult<List<Product>>> GetProducts()
        {
            var products = await _storConext.Products.ToListAsync();
        ...
        {
              var product = await _storConext.Products.FindAsync(id);
